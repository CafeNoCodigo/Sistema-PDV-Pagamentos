...
public class telaInicialController {
    ...
    public void initialize() {
    	...
    	comboIdioma.getItems().addAll("Português", "English", "中文");
    	...
    	comboIdioma.setOnAction(e -> {
			...
			Locale locale = switch (selected) {
    	        ...
    	        case "中文" -> new Locale("zh");
    	        default -> new Locale("pt");
    	    };

    	    LanguageManager.setLocale(locale);
    	    WindowManager.reloadCurrentScene();
    	});
        ResourceBundle bundle = LanguageManager.getBundle();
        atualizarIdioma(bundle);
     
    }
    
    private void atualizarIdioma(ResourceBundle bundle) {
    	lbConfig.setText(bundle.getString("label.config"));
        lbVenda.setText(bundle.getString("label.venda"));
        lbVenda2.setText(bundle.getString("label.venda"));
        lbComprar.setText(bundle.getString("label.comprar"));
        lbComprar2.setText(bundle.getString("label.comprar"));
        lbRegistrar.setText(bundle.getString("label.registrar"));
        lbRelatorio.setText(bundle.getString("label.relatorio"));
        lbOrdem.setText(bundle.getString("label.ordem"));
        lbDevolucao.setText(bundle.getString("label.devolucao"));
        lbPesquisaProduto.setText(bundle.getString("label.pesquisaProduto"));
        lbResumoVendas.setText(bundle.getString("label.resumoVendas"));
        lbCadProduto.setText(bundle.getString("label.cadProduto"));
        lbCadCliente.setText(bundle.getString("label.cadCliente"));
        lbCadFuncionario.setText(bundle.getString("label.cadFuncionario"));
        lbRequisicao.setText(bundle.getString("label.requisicao"));
        lbFluxoCaixa.setText(bundle.getString("label.fluxoCaixa"));
    	...
    	miFuncionario.setText(bundle.getString("menu-item.funcionario"));
    	miEquipamento.setText(bundle.getString("menu-item.equipamento"));
    	miProduto.setText(bundle.getString("menu-item.produto"));
    	miDespesas.setText(bundle.getString("menu-item.despesas"));
    	miServicos.setText(bundle.getString("menu-item.servicos"));
    	miFornecedores.setText(bundle.getString("menu-item.fornecedores"));
    	miCliente.setText(bundle.getString("menu-item.cliente"));
    	miFormaPagamento.setText(bundle.getString("menu-item.formaPagamento"));
    	miRequisicao.setText(bundle.getString("menu-item.requisicao"));
    	miFornecedor.setText(bundle.getString("menu-item.fornecedor"));
    	miProduto2.setText(bundle.getString("menu-item.produto"));
    	miServico2.setText(bundle.getString("menu-item.servicos"));
    	miCliente2.setText(bundle.getString("menu-item.cliente"));
    	miEstoqueProduto.setText(bundle.getString("menu-item.estoqueProduto"));
    	miFluxoCaixa.setText(bundle.getString("menu-item.fluxoCaixa"));
    	miCompraFornecedor.setText(bundle.getString("menu-item.compraFornecedor"));
    	miCompraProduto.setText(bundle.getString("menu-item.compraProduto"));
    	miLucroProduto.setText(bundle.getString("menu-item.lucroProduto"));
    	miLucroEstoque.setText(bundle.getString("menu-item.lucroEstoque"));
    	miContaPagar.setText(bundle.getString("menu-item.contaPagar"));
    	miDevolucao.setText(bundle.getString("menu-item.devolucao"));
    	miAtualizar.setText(bundle.getString("menu-item.atualizar"));
