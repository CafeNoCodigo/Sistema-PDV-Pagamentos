...
public class telaFluxoCaixaController {
	...
	@FXML private Label lbTotalDia, lbTotalSaida, lbTotalMes, lbTotalAno, lbTotalEntrada;
    ...
    private void filtrarPorData() {
        ...
        double totalSaida = vendaDAO.obterSaidaPorData(dataSelecionada);

        lbTotalDia.setText(String.format("MZN %.2f", totalDia));
        lbTotalMes.setText(String.format("MZN %.2f", totalMes));
        lbTotalAno.setText(String.format("MZN %.2f", totalAno));
        lbTotalEntrada.setText(String.format("MZN %.2f", totalEntrada));
        lbTotalSaida.setText(String.format("MZN %.2f", totalSaida));
    }
